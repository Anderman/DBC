...
namespace DataTables
{
    ...
    abstract public class Query
    {
        ...
        internal static DbTransaction _transaction = null;
        ...
        /// <returns>Query instance for chaining</returns>
        public Query Set(string field, dynamic val)
        {
            if (field != null)
            {
                _field.Add(field);
        ...
        /// <returns>Query instance for chaining</returns>
        public Query Set(Dictionary<string, dynamic> fields)
        {
            if (fields != null)
            {
                ...
                {
                    _field.Add(pair.Key);
                    Bind(_bindChar + pair.Key, pair.Value);
                }
            }
        ...
        virtual protected string _BuildSet()
        {
            ...
            {
                vals.Add(_ProtectIdentifiers(_field[i]) + " = " + _bindChar + _SafeBind(_field[i]));
            }
        ...
        virtual protected string _ProtectIdentifiers(string identifier)
        {
            ...
            aliasIdx = identifier.IndexOf(" as ");
            ...
            string[] a = identifier.Split('.');
            return idl + String.Join(idl, a) + idl + alias;
        }
